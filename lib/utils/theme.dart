...
class GoTagTheme with ChangeNotifier {
  static ThemeData light(Color color, bool material3) {
    return ThemeData.light().copyWith(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        ...
        primary: const Color(0xFF242A36), // background (button) color
        onPrimary: const Color(0xFFE2E6ED), // foreground (text) color
      )),
  ...
  static ThemeData dark(Color color, bool material3) {
    return ThemeData.dark().copyWith(
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          onPrimary: const Color(0xFF242A36), // foreground (button) color
          primary: const Color(0xFFE2E6ED), // background (text) color
        ),
      ),
      appBarTheme: const AppBarTheme(
        color: Color(0xFF242A36),
